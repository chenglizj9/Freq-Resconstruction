...
def build_parser() -> argparse.ArgumentParser:
    ...
    p.add_argument("--diff_ckpt", type=str, default="ckp/diffusion_core_omega_sqkpi.pt")
    ...
    p.add_argument("--out_dir", type=str, default="visual_data/diffusion_eval_interpolation/mask_ratio10_sq")
