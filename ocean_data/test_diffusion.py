...
def sample_core(
    ...
    for i, t_idx in enumerate(timestep_seq):
        ...
        if use_dps or use_phys:
            ...
            if guidance_grad_clip > 0.0:
                clip = guidance_grad_clip * (0.5 if i > n_steps * 0.7 else 1.0)
...
def build_parser() -> argparse.ArgumentParser:
    ...
    p.add_argument("--out_dir",    type=str, default="visual_data/ocean_eval")
